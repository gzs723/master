...
import javax.swing.*;
import java.sql.*;
public class DeleteStudents extends JPanel {
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				else
				{
					...
					if(result.next())
					{
						...
						JOptionPane.showMessageDialog(null, "没有该学号的用户","删除",JOptionPane.WARNING_MESSAGE);
									...
									if(grade.getText().toString().equals(""))
									...
									else
										{
											try
											{
												...
												JdbcFile conn=new JdbcFile();
												//产生登录SQL语句
												strsql="delete users where number='"+strnum+"'";
