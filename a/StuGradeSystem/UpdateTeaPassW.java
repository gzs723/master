			...
			public void actionPerformed(ActionEvent e)
			{
				...
				else
				{
					try{
						...
						sqlstr="select *from teacher where number='"+strnum+"'";
					//创建数据库连接
					...
					if(result.next())
					{
						...
						JOptionPane.showMessageDialog(null, "没有该编号的教师","修改",JOptionPane.WARNING_MESSAGE);
							...
							JOptionPane.showMessageDialog(null, "密码不能为空","修改",JOptionPane.WARNING_MESSAGE);	
									...
									else
										{
											try
											{
												...
												JdbcFile conn=new JdbcFile();
												//产生登录SQL语句
												strsql="update teacher set password1='"+strpassword+"'where number='"+strnum+"'";
