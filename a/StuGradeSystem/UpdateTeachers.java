			...
			public void actionPerformed(ActionEvent e)
			{
				...
				else
				{
					...
					if(result.next())
					{
						...
						JOptionPane.showMessageDialog(null, "没有该教师编号的用户","修改",JOptionPane.WARNING_MESSAGE);
								...
								JOptionPane.showMessageDialog(null, "学院不能为空","修改",JOptionPane.WARNING_MESSAGE);	
							else
										{
											try
											{
												...
												if(k>0)
													if(k>0)
														JOptionPane.showMessageDialog(null,"修改教师信息成功！","修改",JOptionPane.WARNING_MESSAGE);
											}catch(SQLException ex)
											{
												System.out.println(ex);
											}catch(ClassNotFoundException ce)
